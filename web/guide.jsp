<%-- 
    Document   : guide
    Created on : Oct 29, 2017, 10:57:30 AM
    Author     : thanh
--%>
...
<body>
	<nav class="navbar-inverse-1" style="background-color: #0c3953;">
        <div class="container">
            <div class="col-md-2 col-sm-2 col-xs-4">
                <a href="#"><img class="img-logo" src="image/header/logo_blue.svg">
                </a>
            </div>
            <ul class="nav navbar-nav navbar-right">
                 <button class="btn btn-table" style="margin-top: 10px;">Đến bảng của bạn</button>
            </ul>
        </div>
    </nav>
    ...
    <div style="background: #42548e;height: 800px;">
        <div class="tour-2" style="text-align: center;">
        	...
        	<div class="row-guide">
				<div class="col-md-3">
					<a href="#"><img id="img-business" src="image/businsess/business-class-burgerfi.jpg" alt=""></a>
				</div>
				<div class="col-md-3">
					<a href="#"><img id="img-business" src="image/businsess/business-class-mccorvey.jpg" alt=""></a>
				</div>
				<div class="col-md-3">
					<a href="#"><img id="img-business" src="image/businsess/business-class-deutschebahn.jpg" alt=""></a>
				</div>
	        </div>
    ...
    <div class="guide-table">
		<p id="guide-table">Còn chần chừ gì nữa?<br>
			Hãy mở bảng ra và <strong>bắt đầu thực hiện các công việc nào!</strong></p>
    </div>
</body>
</html>
