<%-- 
    Document   : card
    Created on : Oct 29, 2017, 9:42:48 AM
    Author     : thanh
--%>
    ...
    <div class="body-card" style="height: 200px; background-color: #EDEFF0;"><br>
        <div class="container">
            <div class="row">    
                ...
                <div class="col-md-8">
                    <label style=" margin-left: 40px;margin-top: 40px;">Thanhquang10</label><span>@thanhquang101</span><br>
        ...
        <div id="exTab2" class="container"> 
            ...
            <div class="tab-content ">
                <div class="tab-pane active" id="1">
                    <label class="glyphicon glyphicon-tasks"> Hoạt động</label>
                    <hr>
                    <div class="list-actions" style="height: 80px; background-color: #D6DADC">
                        <p class="empty-list" style="margin-top: 30px;">Không có hoạt động nào trong 30 ngày qua</p>
                    </div>
                    <a class="load-action" href="#"><span class="text">Tải thêm hoạt động</span></a>
                </div>
                <div class="tab-pane" id="2"><br>
                    <div class="row">
                        <div class="col-md-3">
                            <a href="#" class="sort" id="sort-card"> Sắp xếp theo <strong>bảng</strong></a>
                            <div id="Sort-Card" style="display:none;">
                                <a href="#" class="big-mail"><strong>Lọc theo bảng</strong></a>
                                <a href="#" class="big-mail"><strong>Sắp xếp theo ngày hết hạn</strong></a>
                            </div>
                        </div>
                        <div class="col-md-5">
                            <a href="#" class="sort" id="show-card"> Hiển thị các thẻ trong <strong>tháng</strong> trước</a>
                            <div id="Show-card" style="display:none;">
                                <a href="#" class="big-mail"><strong>Hiển thị các thẻ hoạt động trong ngày gần nhất.</strong></a>
                                <a href="#" class="big-mail"><strong>Hiển thị các thẻ hoạt động trong tuần trước.</strong></a>
                                <a href="#" class="big-mail"><strong>Hiển thị các thẻ hoạt động trong tháng trước.</strong></a>
                                <a href="#" class="big-mail"><strong>Hiển thị các thẻ hoạt động trong năm trước .</strong></a>
                                <a href="#" class="big-mail"><strong>Hiển thị tất cả các thẻ .</strong></a>
                            </div>
                        </div>

                    </div>
                    <div class="list-actions" style="height: 200px; background-color: #D6DADC; margin-top: 30px;">
                ...
                <div class="tab-pane" id="3">
                    <div class="popover-demo">
                        <h4><strong>Chi tiết tài khoản</strong></h4>
                        <hr>
                        <div>
                            <a class="big-link" href="#" id="change-resume"><span class="text">Thay đổi Tên, Chữ ký hoặc Lý lịch...</span></a>
                            <div id="Change-Resume" style="display:none;">
                                ...
                                <button class="btn btn-default email" type="">Lưu</button><hr>
                        ...
                        <a class="big-link" href="#"><span class="text">Thay đổi ảnh đại diện...</span></a>
                        <div>
                            <a class="big-link" href="#" id="change-password"><span class="text">Thay đổi mật khẩu...</span></a>
                            <div id="Change-Password" style="display:none;">
                                ...
                                <button class="btn btn-default email" type="">Lưu</button>
                            </div>
                        </div>
                        <div class="change-email">
                            <a class="big-link" href="#" id="change-email"><span class="text">Thay đổi Email...</span></a>
                            <div id="Change-Email" style="display:none;">
                                ...
                                <button class="btn btn-default email" type="">Thay đổi Email</button>
                            </div>
                        </div>
                        <div class="change-languages">
                            <a class="big-link" href="#" id="change-language"><span class="text">Thay đổi ngôn ngữ...</span></a>
                            <div id="Change-Language" style="display:none;">
                                <a href="">Čeština</a><br>
                                <a href="">Čeština</a><br>
                                <a href="">Deutsch</a><br>
                                <a href="">English (AU)</a><br>
                    ...
                    <div class="chungchi">
                        ...
                        <div>    
                            ...
                            <div id="AddEmail" style="display:none;">
                                ...
                                <button class="btn btn-default email" type="">Gửi Email xác minh</button>
                                <hr id="hr">
                    ...
                    <div class="thongbao">
                        ...
                        <hr>                       
                        <div>
                           <a class="big-link" href="#" id="a-email">Thay đổi tần suất thông báo qua Email...</a>
                            <div id="divEmail" style="display:none;">
                                <a class="big-mail" href="#"><span class="text"><strong>Không bao giờ</strong><br>Đừng gửi những Email</span></a>
                                <a class="big-mail" href="#"><span class="text"><strong>Định kỳ</strong><br>Gửi mỗi Email một lần mỗi giờ.</span></a>
                                <a class="big-mail" href="#"><span class="text"><strong>Ngay lập tức</strong><br>Gửi những Email sớm nhất có thể</span></a>
                            </div>
                        </div>
                        <a class="big-link" href="#"><span class="text">Cho phép thông báp trên Desktop</span></a>
                    </div>
                    <div class="access">
                        <h4>Quyền truy cập</h4>
                        <hr>
                        <a class="big-link js-change-name-and-bio" href="#"><span class="text">Bật chế độ hỗ trợ người mù màu</span></a>
                    </div>
                    ...
                    <hr>
                    <a class="big-link" href="#"><span class="text">Cấu hình bảo mất hai lớp</span></a><br>
                    <div>
                ...
                <div class="tab-pane" id="4">
                    <div style="text-align: center;"> 
                        <p><strong>Nhận thêm tính năng thú vị và hấp dẫn.</strong></p>
                        <p class="big-link">Trello Gold bao gồm tất cả các tính năng phổ thông của Trello cộng thêm...</p>
                        <div class="row">
                            <div class="col-md-4">
                                <img id="img-business-2" src="image/businsess/feature-integration.jpg" alt="">
                                <div class="txt-business-4">
                                    <h8>Mở rộng hiệu suất của bạn</h8>
                                    <p>Tăng cường các bảng của bạn bằng các tính năng và tích hợp bổ sung. Bật lên đến ba Phần mở rộng ở mỗi bảng.</p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <img id="img-business-2" src="image/businsess/feature-roadmap.jpg" alt="">
                                <div class="txt-card">
                                    <h8>Các tập đính kèm khổng lồ</h8>
                                    <p>Đính kèm tập 10 MB không đủ lớn? Tải lên tập tin lên đến 250 MB.</p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <img id="img-business-2" src="image/businsess/feature-overview.jpg" alt="">
                                <div class="txt-business-4">
                                    <h8>Trello theo cách của bạn</h8>
                                    <p>Tạo các bảng theo cách bạn thích với hình nền tuỳ chọn, nhãn dán vui nhộn, và những biểu tượng cảm xúc tuỳ chỉnh.</p>
                                </div>
                            </div>
                            <div>
                                <a href="trello-gold.html">Xem toàn bộ các lợi ích.</a>
                            </div>
                            <hr>
                        </div>
                    </div>
