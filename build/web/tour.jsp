<%-- 
    Document   : tour
    Created on : Oct 29, 2017, 11:22:38 AM
    Author     : thanh
--%>
...
<body>
    ...
    <div style="background: blue;">
        <div class="tour-2">
            <p id="txt_body_3"><br><br>Mở thẻ và bạn có thể thêm bình luận, tải lên các tập tin đính kèm, tạo danh sách công việc, thêm nhãn, ngày hết hạn và còn nhiều thứ khác nữa.</p>
        ...
        <div class="tour-4" style="height: 400px">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <p id="txt-tour-4"><strong>Bắt đầu thảo luận với các bình luận và tệp đính kèm.. </strong>Thêm một ghi chú nhanh hoặc chi tiết, lời công kích ở định dạng Markdown. Nhắc đến một thành viên trong bình luận để chắc rằng người đó nhận được thông báo. Thêm tập tin bằng cách tải lên từ máy tính của bạn, Google Drive, Dropbox, Box và OneDrive. Và cả làm sống động nó bằng các biểu tượng Emoji nữa. </p>
                    </div>               
                </div>
            </div>
        </div>
  ...
  <div style="background: blue;">
        <div class="tour-2">
            <p id="txt_body_3"><br><br>Bạn có rất nhiều bảng và người trên Trello?<strong> Sử dụng nhóm để giữ mọi người kết nối với nhau.</strong> Nhóm là tập hợp của nhiều người và bảng như công ty, gia đình hay bạn chung phòng của bạn. Bạn có thể tạo ra nhiều nhóm mà bạn muốn với tài khoản miễn phí của bạn.</p>
